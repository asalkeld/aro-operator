...
func (g *ReconcileCluster) fluentbitImage(acrName string) string {
	return fmt.Sprintf(fluentbitImageFormat, acrName)
}

func (g *ReconcileCluster) mdsdImage(acrName string) string {
	return fmt.Sprintf(mdsdImageFormat, acrName)
}

func (g *ReconcileCluster) ensureNamespace(ctx context.Context, cs *aro.Cluster) error {
...
func (g *ReconcileCluster) applyConfigMap(ctx context.Context, cs *aro.Cluster, cm *v1.ConfigMap) error {
...
func (g *ReconcileCluster) applySecret(ctx context.Context, cs *aro.Cluster, s *v1.Secret) error {
...
func (g *ReconcileCluster) applyServiceAccount(ctx context.Context, cs *aro.Cluster, sa *v1.ServiceAccount) error {
...
func (g *ReconcileCluster) applyDaemonSet(ctx context.Context, cs *aro.Cluster, ds *appsv1.DaemonSet) error {
...
func (g *ReconcileCluster) ReconsileGenevaLogging(ctx context.Context, cs *aro.Cluster) error {
	...
	*/
	...
	/*  TODO
	err = g.applySecret(ctx, cs, &v1.Secret{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "certificates",
			Namespace: cs.Spec.GenevaLogging.Namespace,
		},
